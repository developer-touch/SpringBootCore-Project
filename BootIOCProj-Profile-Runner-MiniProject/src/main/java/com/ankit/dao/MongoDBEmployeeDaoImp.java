...
@Profile({"mgdb"})
@Repository("emp-mgdb")
public class MongoDBEmployeeDaoImp implements IEmployeeDao{
	...
	public MongoDBEmployeeDaoImp() {
		System.out.println("MongoDBEmployeeDaoImp::0-arg constructor");
	}
	
	@Override
	public List<Employee> fetchByDesg(String desg1, String desg2) throws Exception {
		System.out.println("MongoDBEmployeeDaoImp.fetchByDesg()"+ds.getClass());
	...
	public int insert(Employee employee) throws Exception {
		System.out.println("MongoDBEmployeeDaoImp.insert()");
		int result = 0;
		try(Connection con = ds.getConnection();
